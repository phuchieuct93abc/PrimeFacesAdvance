[Ivy]
16C2C375FE2EAB47 3.20 #module
>Proto >Proto Collection #zClass
As0 NoAjaxProcess Big #zClass
As0 RD #cInfo
As0 #process
...
>Proto As0 As0 NoAjaxProcess #zField
As0 f0 guid 16C2C3760106383B #txt
As0 f0 type sample.NoAjax.NoAjaxData #txt
...
As0 f1 type sample.NoAjax.NoAjaxData #txt
As0 f1 211 51 26 26 0 12 #rect
As0 f1 @|RichDialogProcessEndIcon #fIcon
As0 f2 expr out #txt
As0 f2 109 64 211 64 #arcP
As0 f3 guid 16C2C37602BA9ACD #txt
As0 f3 type sample.NoAjax.NoAjaxData #txt
As0 f3 actionDecl 'sample.NoAjax.NoAjaxData out;
' #txt
